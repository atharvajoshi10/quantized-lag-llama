...
# Modified StudentT Distribution which uses Quantized Distribution Module
...
class QuantizedStudentT(TorchStudentT):
...
class QuantizedStudentTOutput(QuantizedDistributionOutput):
    args_dim: Dict[str, int] = {"df": 1, "loc": 1, "scale": 1}
    distr_cls: type = QuantizedStudentT
