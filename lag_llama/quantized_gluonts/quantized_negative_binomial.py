...
# Modified Negative Binomial Distribution which uses Quantized Distribution Module
...
class QuantizedNegativeBinomial(TorchNegativeBinomial):
    """
...
class QuantizedNegativeBinomialOutput(QuantizedDistributionOutput):
    args_dim: Dict[str, int] = {"total_count": 1, "logits": 1}
    distr_cls: type = QuantizedNegativeBinomial
    ...
    def distribution(
        ...
        return QuantizedNegativeBinomial(total_count=total_count, logits=logits)
