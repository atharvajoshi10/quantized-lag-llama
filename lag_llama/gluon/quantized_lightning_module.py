...
from lag_llama.model.quantized_modules import QuantizedLagLlamaModel


class QuantizedLagLlamaLightningModule(LightningModule):
    """
    A ``pl.LightningModule`` class that can be used to train a
    ``QuantizedLagLlamaLightningModule`` with PyTorch Lightning.
    ...
    def __init__(
        ...
        self.model = QuantizedLagLlamaModel(**self.hparams.model_kwargs)
