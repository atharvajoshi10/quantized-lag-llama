...
class QuantizedLagLlamaEstimator(PyTorchLightningEstimator):
    """
    ...
    def create_lightning_module(self, use_kv_cache: bool = False) -> pl.LightningModule:
        ...
        if self.ckpt_path is not None:
            ...
            return QuantizedLagLlamaLightningModule.load_from_checkpoint(
            ...
            return QuantizedLagLlamaLightningModule(
                loss=self.loss,
                lr=self.lr,
                weight_decay=self.weight_decay,
                context_length=self.context_length,
    ...
    def _create_instance_splitter(self, module: QuantizedLagLlamaLightningModule, mode: str):
    ...
    def create_training_data_loader(
        self,
        data: Dataset,
        module: QuantizedLagLlamaLightningModule,
